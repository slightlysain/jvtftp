 ...
 * <p>
 ***/
public final class JvtftpFromNetASCIIInputStream extends PushbackInputStream {
...
//	}
	 ...
	 * InputStream.
	 ***/
	public JvtftpFromNetASCIIInputStream(InputStream input) {
	...
	private int __read() throws IOException {
		...
		if (ch == '\r') {
			ch = super.read();
			if (ch == '\n') {
				if(2 == _lineSeparatorBytes.length) {
					__lastWasNL = true;
					return _lineSeparatorBytes[0];
				} else {
					return _lineSeparatorBytes[0];
				}
			} else if(ch == '\0') {
