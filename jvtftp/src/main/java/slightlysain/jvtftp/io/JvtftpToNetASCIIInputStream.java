 ...
 * <p>
 ***/
public final class JvtftpToNetASCIIInputStream extends FilterInputStream
{
     ...
     ***/
    public JvtftpToNetASCIIInputStream(InputStream input)
    {
        super(input);
    ...
    public int read() throws IOException
    {
        ...
        else if(__status == __LAST_WAS_CR) 
        {
        	__status = __NOTHING_SPECIAL;
         	return '\0';
        }
