...
MACS_KEY = "installSqueezeMACs"
KERNEL_KEY = "squeeze-linux"
INITRD_KEY = "squeeze-initrd.gz"
...
if(request.isRead()) {
	...
	if(matcher.matches()) {
		...
		//		}
		println "start"
		preseed = new ReplaceInputStream("squeeze/squeeze-preseed.cfg", streamFactory)
